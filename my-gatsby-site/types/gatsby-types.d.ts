...
type FeedHatenaConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<FeedHatenaEdge>;
  readonly nodes: ReadonlyArray<FeedHatena>;
  readonly pageInfo: PageInfo;
  readonly distinct: ReadonlyArray<Scalars['String']>;
  readonly group: ReadonlyArray<FeedHatenaGroupConnection>;
};


type FeedHatenaConnection_distinctArgs = {
  field: FeedHatenaFieldsEnum;
};


type FeedHatenaConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: FeedHatenaFieldsEnum;
};
...
type FeedHatenaEdge = {
  readonly next: Maybe<FeedHatena>;
  readonly node: FeedHatena;
  readonly previous: Maybe<FeedHatena>;
};

type FeedHatenaFieldsEnum =
  | 'id'
  | 'parent.id'
  | 'parent.parent.id'
  | 'parent.parent.parent.id'
...
type FeedHatenaGroupConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<FeedHatenaEdge>;
  readonly nodes: ReadonlyArray<FeedHatena>;
  readonly pageInfo: PageInfo;
...
type FeedHatenaMeta_lastBuildDateArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type FeedHatenaMetaConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<FeedHatenaMetaEdge>;
  readonly nodes: ReadonlyArray<FeedHatenaMeta>;
  readonly pageInfo: PageInfo;
  readonly distinct: ReadonlyArray<Scalars['String']>;
  readonly group: ReadonlyArray<FeedHatenaMetaGroupConnection>;
};


type FeedHatenaMetaConnection_distinctArgs = {
  field: FeedHatenaMetaFieldsEnum;
};


type FeedHatenaMetaConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: FeedHatenaMetaFieldsEnum;
};

type FeedHatenaMetaEdge = {
  readonly next: Maybe<FeedHatenaMeta>;
  readonly node: FeedHatenaMeta;
  readonly previous: Maybe<FeedHatenaMeta>;
};

type FeedHatenaMetaFieldsEnum =
  | 'id'
  | 'parent.id'
  | 'parent.parent.id'
  | 'parent.parent.parent.id'
...
type FeedHatenaMetaFilterInput = {
  readonly id: Maybe<StringQueryOperatorInput>;
  readonly parent: Maybe<NodeFilterInput>;
  readonly children: Maybe<NodeFilterListInput>;
  readonly internal: Maybe<InternalFilterInput>;
...
type FeedHatenaMetaGroupConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<FeedHatenaMetaEdge>;
  readonly nodes: ReadonlyArray<FeedHatenaMeta>;
  readonly pageInfo: PageInfo;
...
type FeedHatenaMetaSortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<FeedHatenaMetaFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};

type FeedHatenaSortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<FeedHatenaFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};
...
type Query = {
  ...
  readonly allFeedHatena: FeedHatenaConnection;
...
type Query_allFeedHatenaMetaArgs = {
  filter: Maybe<FeedHatenaMetaFilterInput>;
  sort: Maybe<FeedHatenaMetaSortInput>;
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
};


type Query_feedHatenaArgs = {
  id: Maybe<StringQueryOperatorInput>;
  parent: Maybe<NodeFilterInput>;
  children: Maybe<NodeFilterListInput>;
  internal: Maybe<InternalFilterInput>;
...
type Query_allFeedHatenaArgs = {
  filter: Maybe<FeedHatenaFilterInput>;
  sort: Maybe<FeedHatenaSortInput>;
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
};
